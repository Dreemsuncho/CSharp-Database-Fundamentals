...
*/
CREATE TABLE Teachers(TeacherID INT NOT NULL,
                      Name VARCHAR(50),
                      ManagerID INT)
...
CREATE TABLE ItemTypes (ItemTypeID INT PRIMARY KEY IDENTITY,
                        Name VARCHAR(50))

CREATE TABLE Items (ItemID INT PRIMARY KEY IDENTITY,
                    Name VARCHAR(50),
                    ItemTypeID INT FOREIGN KEY REFERENCES ItemTypes(ItemTypeID))

CREATE TABLE Cities(CityID INT PRIMARY KEY IDENTITY,
                    Name VARCHAR(50))
...
CREATE TABLE Majors(MarjorID INT PRIMARY KEY,
                    Name VARCHAR(50))

...
AS
SELECT 
	FirstName + ' ' + IIF(MiddleName IS NULL, '', MiddleName) + ' ' + LastName AS [Full Name], 
	JobTitle 
FROM
	Employees
...
-- Find all countries along with information about their currency. Display the country code, country name and 
